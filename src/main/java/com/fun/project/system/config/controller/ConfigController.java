package com.fun.project.system.config.controller;
...
import com.fun.project.system.config.domain.Config;
...
public class ConfigController extends BaseController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public R addSave(@Validated Config config) {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public R editSave(@Validated Config config) {
        if (UserConstants.CONFIG_KEY_NOT_UNIQUE.equals(configService.checkConfigKeyUnique(config))) {
