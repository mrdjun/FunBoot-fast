...
import com.fun.project.system.post.service.IPostService;
import com.fun.project.system.role.domain.Role;
import com.fun.project.system.role.service.IRoleService;
...
public class UserController extends BaseController
{
    ...
    @PostMapping("/add")
    @ResponseBody
    public R addSave(@Validated User user)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public R editSave(@Validated User user)
    {
    ...
    @ResponseBody
    public R resetPwdSave(User user)
    {
        userService.checkUserAllowed(user);
