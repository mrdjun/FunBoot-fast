...
import com.fun.common.exception.job.TaskException;
...
import com.fun.project.monitor.job.util.CronUtils;
...
public class JobController extends BaseController {
    ...
    @ResponseBody
    public R changeStatus(Job job) throws SchedulerException {
    ...
    @PostMapping("/add")
    @ResponseBody
    public R addSave(@Validated Job job) throws SchedulerException, TaskException {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public R editSave(@Validated Job job) throws SchedulerException, TaskException {
        if (!CronUtils.isValid(job.getCronExpression())) {
            return R.error("cron表达式不正确");
        }
